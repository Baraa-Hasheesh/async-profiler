...
public class JfrTests {
     ...
     * @throws Exception Any exception thrown during profiling JFR output parsing.
     */
    @Test(mainClass = JfrMultiModeProfiling.class, agentArgs = "start,threads,event=cpu,begin=elapsedTimer::start,end=elapsedTimer::stop,alloc,lock=0,quiet,cstack=vmx,jfr,file=%f", output = true)
